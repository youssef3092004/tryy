...
class Dragons:
    ...
    def lobby_page(self):
        ...
        self.selected_track = "Ahmed Santa: Emna3-elklam"  
        self.current_music_label = Label(music_frame, text=f"The Music is: {self.selected_track}", font=("Arial", 14), bg="#F0F0F0", fg="#333")
    ...
    def update_music_selection(self, event):
        ...
        self.current_music_label.config(text=f"{selected_track}")
        self.play_music()
